...
// entity :  user | repo | starred | stargazers | express
...
//export const fetchExpress    = fetchEntity.bind(null, express,api.fetchExpressByID)
...
// 加载express信息
// function* loadExpressInfo(express){
  
//   yield call(fetchExpress,express,'listUsers')
// }
